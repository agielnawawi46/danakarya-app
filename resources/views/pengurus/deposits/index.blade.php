...
<div class="flex justify-between items-center" style="margin-bottom:16px;">
  <div style="font-size:16px; font-weight:600; color:var(--gray-800);">
    Periode: {{ $currentPeriod->translatedFormat('F Y') }}
  </div>
...
{{-- Filter --}}
<form class="flex gap-2 flex-wrap" style="margin-bottom:16px; align-items: stretch;">

  <select name="month" class="form-control" style="width:auto; padding:4px 32px 4px 12px; font-size:14px;" onchange="this.form.submit()">
    @foreach([
  ...
  <select name="year" class="form-control" style="width:auto; padding:4px 32px 4px 12px; font-size:14px;" onchange="this.form.submit()">
